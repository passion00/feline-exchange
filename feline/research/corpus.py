...
class TwelveDataDownloader:
 ...
 def _http(self,url,timeout):
  with request.urlopen(request.Request(url,headers={"User-Agent":"FelineExchange/0.11.1 research"}),timeout=timeout) as response:return json.loads(response.read())
