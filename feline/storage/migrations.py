MIGRATIONS: tuple[str, ...] = (
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS realtime_validation_summaries (
      validation_session_id TEXT PRIMARY KEY,
      realtime_session_id TEXT NOT NULL,
      validation_mode TEXT NOT NULL,
      created_at TEXT NOT NULL,
      status TEXT NOT NULL,
      payload TEXT NOT NULL,
      FOREIGN KEY(realtime_session_id) REFERENCES realtime_sessions(realtime_session_id)
    );
