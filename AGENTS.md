...
v0.12 data invariant: adapters preserve provider symbol, price basis,
...
4. Feline v0.12 has no live broker implementation or real-order path. Paper/research mode is the only mode and default.
