...
v0.13 data invariant: adapters preserve provider symbol, price basis,
...
4. Feline v0.13 has no live broker implementation or real-order path. Realtime ingestion can drive only the existing paper broker; paper/research mode remains mandatory.
